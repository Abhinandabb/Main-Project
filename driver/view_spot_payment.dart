...
//         useMaterial3: true,
//       ),
//       home: const view_spot_payment(title: 'Flutter Demo Home Page'),
//     );
//   }
// }
//
// class view_spot_payment extends StatefulWidget {
//   const view_spot_payment({super.key, required this.title});
//
//
//   final String title;
//
//   @override
//   State<view_spot_payment> createState() => _view_spot_paymentState();
// }
//
// class _view_spot_paymentState extends State<view_spot_payment> {
// _view_spot_paymentState(){
//   getdata();
// }
//   @override
//   Widget build(BuildContext context) {
...
//       String url = '$urls/d_view_spot_payment/';
//
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const view_spot_payment(title: 'Payment History'),
    );
  }
}
...
class _view_spot_paymentState extends State<view_spot_payment> {
  ...
  List id_ = [], date_ = [], amount_ = [],  status_ = [], user_ = [], type_ = [];
